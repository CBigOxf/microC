...
;; This file was generated by the Behaviour Composer at modelling4all.org on Thu Apr 05 12:40:51 UTC 2018
;; The model can be found at http://794-dot-m4a-gae-hrd.appspot.com//m/?frozen=GNKqn0lKbAzaQHx8VXfp6a
...
to the-model [ globals-not-to-be-initialised ]
   ...
   ask all-of-kind "World 2D"
       [ -SIZE-OF-CANVAS-16
         -WORLD-IS-3D-6
         -WORLD-GEOMETRY-6
         -LAYOUT-CELLS-IN-CIRCLE-3 ]
...
to-report one-of-each-mutation-group
 ...
 ; Lays out a set of agents centred around the specified point. Places one agent per patch.
to layout-in-circle [ agents center-x center-y ]
   let radius
       0
   while [ any? agents ]
         [ set radius
           ...
           let empty-patches-in-radius
               patches with [ not any? turtles-here and distancexy center-x center-y <= radius ]
           let agents-to-place
               0
 ...
 ; 2D version includes a dummy 3D version that isn't called but occurs conditionally in the code
...
to -SIZE-OF-CANVAS-16
                      ;set the-xmin-of-canvas -25
                      ;set the-xmax-of-canvas 25
                      ;set the-ymin-of-canvas -40
                      ;set the-ymax-of-canvas -20
                      ;
...
to -WORLD-GEOMETRY-6
                     ; Change the initial geometry of the world to be either a plane, a torus, a horizontal or vertical cylinder, or a plane with a camera  that follows the average position of all individuals.
   set-world-geometry 4
end

to -LAYOUT-CELLS-IN-CIRCLE-3
   layout-in-circle all-of-kind "Cell" 0 0
end
