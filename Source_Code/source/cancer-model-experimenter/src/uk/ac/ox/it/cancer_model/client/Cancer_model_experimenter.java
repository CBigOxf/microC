...
public class Cancer_model_experimenter implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		// Experiment with onModule response
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendParametersToServer() {
				...
				experimentService.experimentServer(numberOfReplicates, emailAddress, date, parameterNames,
						parameterValues, serverFiles, run3D, host, new AsyncCallback<String>() {
	...
	public static void addFileUploadWidget() {
		...
		panel.add(new Label(
				"Use this to upload any customisations of the default settings. Any of mutations.txt, input.txt, or regulatoryGraph.html."));
		...
		submitFileButton.setTitle(
				"Click this after choosing one of these files mutations.txt, input.txt, or regulatoryGraph.html");
		...
		final CheckBox checkBox3D = new CheckBox(
				"Check this if you wish to run the model with a three dimensional array of cells.");
